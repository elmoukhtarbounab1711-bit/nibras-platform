...
def search_decisions():
    ...
    total = services_jurisprudence.count_search_decisions(
        q, category_slug=request.args.get("category")
    )
    return jsonify({"query": q, "count": total, "total": total, "results": results})
